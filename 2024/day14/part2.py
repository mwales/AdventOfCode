...
class Grid:
	...
	def treeCheck(self):
		gs = self.gridToString()

		if gs.find("1111111111111111111111111111111") == -1:
			return False
		if gs.find("1..........111111111..........1") == -1:
			return False
		if gs.find("1.............111.............1") == -1:
			return False
...
def main(argv):
	...
	for i in range(100000):
		print(f"Grid after {i+1} iterations")
		g.iterateState(1)
		if (g.treeCheck()):
			g.displayGrid()
